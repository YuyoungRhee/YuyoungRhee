### 안녕하세요 백엔드 개발자 이유영입니다.

- 안정적인 서버 아키텍처와 읽기 좋은 코드를 지향합니다.
- 사용자의 불편함을 기술로 해결하는 과정에서 즐거움을 느낍니다. 
- 좋은 테스트에 관심이 있으며 테스트 가능한 코드를 작성하기 위해 노력합니다.
...
- 덕성여자대학교 사이버보안전공 학사 졸업(2021.03 - 2025.08)
